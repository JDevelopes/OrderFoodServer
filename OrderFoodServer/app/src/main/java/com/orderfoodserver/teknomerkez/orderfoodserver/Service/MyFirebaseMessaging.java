...
import com.orderfoodserver.teknomerkez.orderfoodserver.Helper.NotificationHelper;
import com.orderfoodserver.teknomerkez.orderfoodserver.MainActivity;
import com.orderfoodserver.teknomerkez.orderfoodserver.OrderStatus;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNotificationBuil26(RemoteMessage remoteMessage) {
        ...
        }else{ // fix crash if notification send from news system (user != null=
            Uri defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
